...
public class TelnetServer implements Observer {
	...
	private autocrawler.State state = autocrawler.State.getReference();
	private autocrawler.Settings settings = Settings.getReference();
...
//		}
	...
	public TelnetServer(autocrawler.Application a) {
		app = a;
