...
public class SystemWatchdog {
	...
	static final String AP = "autocrawler";
...
//					String str="<span style='font-size: 12px'>("+Util.getDateStamp()+")</span><br><br>";
	...
	private void notifyPowerError() {
		...
		else if (!warningonly) callForHelp("Autocrawler POWER ERROR","Please UNPLUG BATTERY and consult technical support");
		else if (warningonly && commlost) callForHelp("Autocrawler POWER ERROR","Power PCB Communication Lost");
	}
	...
	public void redock(String str) {
		...
		new Thread(new Runnable() { public void run() {
			redocking = true;
			long start;
			String subject = "Autocrawler Unable to Dock";
